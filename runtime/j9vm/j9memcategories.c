...
#endif /* OMR_OPT_CUDA */
OMRMEM_CATEGORY_2_CHILDREN("Classes", J9MEM_CATEGORY_CLASSES, J9MEM_CATEGORY_CLASSES_SHC_CACHE, J9MEM_CATEGORY_CLASSES_CRV);
OMRMEM_CATEGORY_NO_CHILDREN("Shared Class Cache", J9MEM_CATEGORY_CLASSES_SHC_CACHE);
OMRMEM_CATEGORY_2_CHILDREN("Class Relationship Verifier", J9MEM_CATEGORY_CLASSES_CRV, J9MEM_CATEGORY_CLASSES_CRV_RELATIONSHIPS, J9MEM_CATEGORY_CLASSES_CRV_SNIPPETS);
OMRMEM_CATEGORY_NO_CHILDREN("Class Relationship Verifier Relationships", J9MEM_CATEGORY_CLASSES_CRV_RELATIONSHIPS);
OMRMEM_CATEGORY_NO_CHILDREN("Class Relationship Verifier Snippets", J9MEM_CATEGORY_CLASSES_CRV_SNIPPETS);

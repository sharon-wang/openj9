...
#else /* OMR_OPT_CUDA */
OMRMEM_CATEGORY_9_CHILDREN("VM", OMRMEM_CATEGORY_VM, J9MEM_CATEGORY_CLASSES, J9MEM_CATEGORY_MODULES, OMRMEM_CATEGORY_MM, OMRMEM_CATEGORY_THREADS, OMRMEM_CATEGORY_TRACE, J9MEM_CATEGORY_JVMTI, J9MEM_CATEGORY_JNI, OMRMEM_CATEGORY_PORT_LIBRARY, J9MEM_CATEGORY_CLASSRELATIONSHIPS);
#endif /* OMR_OPT_CUDA */
...
OMRMEM_CATEGORY_2_CHILDREN("Class Relationships", J9MEM_CATEGORY_CLASSRELATIONSHIPS, J9MEM_CATEGORY_CLASSRELATIONSHIPS_STRINGS, J9MEM_CATEGORY_CLASSRELATIONSHIPS_HASHTABLE);
OMRMEM_CATEGORY_NO_CHILDREN("Class Relationships STRINGS", J9MEM_CATEGORY_CLASSRELATIONSHIPS_STRINGS);
OMRMEM_CATEGORY_NO_CHILDREN("Class Relationships HASHTABLES", J9MEM_CATEGORY_CLASSRELATIONSHIPS_HASHTABLE);
#if defined(OMR_OPT_CUDA)
...
CATEGORY_TABLE_ENTRY(J9MEM_CATEGORY_CLASSRELATIONSHIPS),
CATEGORY_TABLE_ENTRY(J9MEM_CATEGORY_CLASSRELATIONSHIPS_STRINGS),
CATEGORY_TABLE_ENTRY(J9MEM_CATEGORY_CLASSRELATIONSHIPS_HASHTABLE),
#if defined(OMR_OPT_CUDA)
